...
<!-- ----------------------------    CORONA LATEST UPDATE    ------------------------------  -->
    ...
    <section class="corona_update">
        ...
        <div class="d-flex justify-content-around align-item-center">
            <div>
                <h1>677#</h1>
                <p>Total Confirmed cases (Indian National)</p>
            </div>

            <div>
                <h1 class="count">47</h1>
                <p>Total Confirmed cases ( Foreign National )</p>
            </div>
        ...
        <div class="d-flex justify-content-around align-item-center"></div>
            <h1 class="count">#</h1>
            <p class="text-center"># Shows a few of the new cases have been reassigned States as per latest information</p>
        </div>
    </section>
...
<div class="container-fluid  pt-5 pb-5" id="contactid">
    <div class="section_header text-center mb-5 mt-4">
        ...
        <p>Helpline number for M.P 104</p>
    </div>
    <din class="container">
        <div class="row">
    ...
    <div class="footer">
        <p> COPYRIGHTS @ ABHISHEK SHARMA <span class="foot_top"> <a href="#">  TOP </a></span> </p>
  </div>
</body>
